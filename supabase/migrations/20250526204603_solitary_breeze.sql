/*
  # Add Genie Documentation Category and Content

  1. Changes
    - Add Genie documentation category
    - Add initial user guide content
    - Set up proper content organization

  2. Security
    - Maintain existing RLS policies
*/

-- Insert Genie documentation category
...
-- Insert main user guide content
...
Genie is continuously evolving to provide better healthcare insights and support. Stay updated with our newsletter for the latest features and improvements.',
  ...
  'approved',
  (SELECT id FROM rag_categories WHERE slug = 'genie-docs'),
